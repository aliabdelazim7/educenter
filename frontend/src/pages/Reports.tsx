      ...
      <div className="flex-1 flex flex-col p-8 overflow-y-auto relative" dir="rtl">
        ...
        <div className="flex justify-between items-center mb-8 border-b border-slate-900 pb-4">
          <div className="space-y-1 text-right">
            <h1 className="text-2xl font-bold tracking-tight text-slate-50">التقارير المالية والأرباح</h1>
            <p className="text-sm text-slate-400">تابع حركة الخزنة، المصاريف الإدارية، مستحقات المعلمين، وصافي الربح للمركز.</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="space-y-8 max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              {/* Total Revenue */}
              <div className="rounded-xl border border-slate-900 bg-slate-950/40 p-5 space-y-3 relative overflow-hidden">
                ...
                <div className="text-right">
                  <p className="text-xs text-slate-400 font-medium">إجمالي الإيرادات (الدخل)</p>
              ...
              <div className="rounded-xl border border-slate-900 bg-slate-950/40 p-5 space-y-3 relative overflow-hidden">
                ...
                <div className="text-right">
                  <p className="text-xs text-slate-400 font-medium">المصاريف الإدارية</p>
              ...
              <div className="rounded-xl border border-slate-900 bg-slate-950/40 p-5 space-y-3 relative overflow-hidden">
                ...
                <div className="text-right">
                  <p className="text-xs text-slate-400 font-medium">مستحقات المدرسين</p>
                  <p className="text-xl font-black text-violet-400 mt-1">{calculatedTeacherCommissions.toLocaleString('ar-EG')} ج</p>
                </div>
              </div>

              {/* Net Profit */}
              <div className="rounded-xl border border-slate-900 bg-slate-950/40 p-5 space-y-3 relative overflow-hidden border-violet-500/20 bg-violet-950/5">
                ...
                <div className="text-right">
                  <p className="text-xs text-slate-300 font-bold">الأرباح الصافية المتبقية</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              ...
              <div className="lg:col-span-2 space-y-4">
                <h3 className="text-base font-bold text-slate-300 text-right">كشف الحساب ودفتر اليومية للأنشطة</h3>
                    ...
                    <tbody className="divide-y divide-slate-900 text-xs">
                      {ledger.map((entry) => (
                        <tr key={entry.id} className="hover:bg-slate-900/10 transition-all">
                          <td className="px-6 py-4 font-bold text-slate-200">{entry.description}</td>
                          <td className="px-6 py-4 text-slate-400">{entry.category === 'revenue' ? 'إيراد / تحصيل' : 'مصاريف تشغيل'}</td>
              ...
              <div className="rounded-xl border border-slate-900 bg-slate-950/40 p-6 space-y-6">
                <div className="border-b border-slate-900 pb-3 text-right">
                ...
                <div className="space-y-4">
                  {teachers.map((t) => {
                    ...
                    return (
                      <div key={t.id} className="flex justify-between items-center text-xs border-b border-slate-900 pb-3 last:border-b-0 last:pb-0 text-right">
                        <div className="space-y-1">
                          <p className="font-bold text-slate-200">{t.user.name}</p>
                ...
                <div className="border-t border-slate-900 pt-4 space-y-3">
                  <label className="text-[11px] font-bold text-slate-400 block text-right">تغيير معايير احتساب عمولات المعلمين</label>
                  <div className="grid grid-cols-2 gap-2 text-right">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full rounded bg-slate-900 border border-slate-800 px-2 py-1 text-xs text-slate-250 text-right font-mono"
                      />
                    </div>
                    <div className="space-y-1">
