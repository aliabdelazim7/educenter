            ...
            <div className="rounded-xl border border-slate-200 dark:border-slate-900 bg-slate-50 dark:bg-slate-950/40 overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse" dir="rtl">
                  <thead>
                    <tr className="border-b border-slate-200 dark:border-slate-900 bg-white dark:bg-slate-900/30 text-xs font-bold uppercase tracking-wider text-slate-500 text-right">
                  ...
                  <tbody className="divide-y divide-slate-900 text-sm text-right">
                    {students.map((student) => {
                      ...
                      return (
                        <tr key={student.id} className="hover:bg-white dark:bg-slate-900/20 transition-all">
                          {/* Student Details */}
                          ...
                          {/* Status Options */}
                          <td className="px-6 py-4">
                            <div className="inline-flex rounded-lg bg-white dark:bg-slate-900 p-1 border border-slate-200 dark:border-slate-800/80">
                              <button
                                type="button"
                          ...
                          <td className="px-6 py-4">
                            <input
                              ...
                              className="w-full max-w-xs rounded-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 px-3 py-1.5 text-xs text-slate-900 dark:text-slate-100 placeholder-slate-600 outline-none focus:border-violet-200 dark:focus:border-violet-500/50 transition-all text-right"
                            />
                          </td>
                        </tr>
                      )
