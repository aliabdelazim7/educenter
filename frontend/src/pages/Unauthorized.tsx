...
export const Unauthorized: React.FC = () => {
  return (
    <div className="flex min-h-screen w-screen flex-col items-center justify-center bg-slate-950 text-slate-100 px-6 font-sans">
      <div className="relative flex flex-col items-center max-w-md text-center space-y-6">
        ...
        <div className="space-y-2">
          <h1 className="text-3xl font-extrabold tracking-tight text-slate-50">غير مسموح بالدخول</h1>
        ...
        <Link
          to="/dashboard"
          className="inline-flex items-center gap-2 rounded-lg bg-slate-900 border border-slate-800 hover:border-slate-700 px-4 py-2.5 text-sm font-semibold text-slate-200 transition-all"
        >
